...
#include "obj_dir_Control/VControl.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_Control/VControl__Syms.h"
#include "svdpi.h"
#endif
...
VControl_t * create_model( const char *vcd_filename ) {
  ...
  m     = (VControl_t *) malloc( sizeof(VControl_t) );
  model = new VControl();
...
void destroy_model( VControl_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VControl * model = (VControl *) m->model;
...
#if VLINETRACE
void trace( VControl_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_Control__v );
