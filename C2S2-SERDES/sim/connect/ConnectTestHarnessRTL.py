...
class ConnectTestHarnessVRTL( VerilogPlaceholder, Component ):
  # Constructor
  def construct( s, BIT_WIDTH = 32, N_SAMPLES = 8):
    # If translated into Verilog, we use the explicit name
    s.set_metadata( VerilogTranslationPass.explicit_module_name, 'connect' )
    # Interface
...
# Import the appropriate version based on the rtl_language variable
  ...
  connect = ConnectTestHarnessVRTL ##### check line?
else:
